...
- در صورت شکست آزمون (FAIL)، فوراً برچسب قرمز «غیرمجاز جهت استفاده» نصب گردد.`,
  },
  {
    ...
    description: 'زمانبندی حضور اعضای تیم کد ۹۹ (حداکثر ۳ دقیقه)، شارژ ترالی احیا، مدیریت داروها و ثبت فرم احیا در سامانه هاسیار (Hosyar)',
...
۵. بعد از لمس محیط اطراف بیمار`,
  ...
  // Folder 5: Inside "۵. دستورالعمل‌های انبارداری و ثبت اموال" (f-inventory)
  {
    ...
    department: 'انبار و اموال',
    description: 'روش استاندارد الصاق پلاک فلزی و لیبل بارکد ۲ بعدی، نحوه خواندن کد دارایی در نرم‌افزار هاسیار و تطبیق فیزیکی سالانه',
...
- فرآیند ثبت صورتجلسه جابجایی دستگاه بین بخش‌ها در سامانه هاسیار`,
  },
  {
    ...
    status: 'published',
    scopeLevel: 'unassigned',
    content: `# چرخه حیات پیش‌نویس اموال در سیستم هاسیار
